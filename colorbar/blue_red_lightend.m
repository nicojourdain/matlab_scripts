function c = blue_red_lightend(m)
%blue_red_lightend    Shades of dark red and blue color map
%   blue_red_lightend(M), is an M-by-3 matrix that defines a colormap.
%
%   The colormap blue_red_lightend goes from purple to dark red via white at its center
%
%   blue_red_lightend, by itself, is the same length as the current figure's
%   colormap. If no figure exists, MATLAB creates one.
%
%   For example, to reset the colormap of the current figure:
%
%             colormap(blue_red_lightend)
%
...
%             (3) green
%             (4) blue
MM = [ 0.000 0.85 0.65 0.80 ; ...
       0.125 0.44 0.19 0.62 ; ...
       0.175 0.16 0.20 0.43 ; ...
       0.350 0.32 0.78 0.94 ; ...
       0.490 1.00 1.00 1.00 ; ...
       0.510 1.00 1.00 1.00 ; ...
       0.625 0.96 0.92 0.23 ; ...
       0.750 0.89 0.22 0.18 ; ...
       0.900 0.20 0.00 0.00 ; ...
       1.000 0.80 0.60 0.40 ];
