function c = terrestrial(m)
%terrestrial
%   terrestrial(M), is an M-by-3 matrix that defines a colormap.
%
%   The colormap terrestrial is inspired by Ferret's terrestrial_cmyk.
%
%   terrestrial, by itself, is the same length as the current figure's
%   colormap. If no figure exists, MATLAB creates one.
%
%   For example, to reset the colormap of the current figure:
%
%             colormap(terrestrial)
%
