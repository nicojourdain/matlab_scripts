function c = blue_red_nico(m)
%blue_red_nico    Shades of dark red and blue color map
%   blue_red_nico(M), is an M-by-3 matrix that defines a colormap.
%   The colors begin with dark blue, range through shades of
%   blue to white, and then through shades of red to dark red.
%   blue_red_nico, by itself, is the same length as the current figure's
%   colormap. If no figure exists, MATLAB creates one.
%
%   For example, to reset the colormap of the current figure:
%
%             colormap(blue_red_nico)
%
...
% ----------pink-------------deep purple------------darkblue--------------azur------------white--  -----white-----dark yellow----------red------------dark red-------light brown-----
%if (mod(m,2) == 0)
%    m0 = m*0.5;
%else
%    m0 = floor(m*0.5);
